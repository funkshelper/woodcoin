...
static const char qt_meta_stringdata_PaperWalletDialog[] = {
    "PaperWalletDialog\0\0on_getNewAddress_clicked()\0"
...
const QMetaObjectExtraData PaperWalletDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PaperWalletDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PaperWalletDialog,
      qt_meta_data_PaperWalletDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PaperWalletDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaperWalletDialog))
